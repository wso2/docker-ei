### WSO2 Enterprise Integrator Pattern-5 deployment with Docker compose
...
Navigate to `<DOCKER_HOME>/docker-compose/pattern-5`
...
* Mysql server (container) with `WSO2_CONFIG_DB, WSO2_REG_DB, WSO2_USER_DB`
