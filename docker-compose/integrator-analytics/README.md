 ...
 * If you wish to run the Docker Compose setup using Docker images built locally, build Integrator, Analytics Docker images using [Dockerfiles](../../dockerfiles) and remove the `docker.wso2.com/` prefix from the `image` name In the `docker-compose.yml`. <br> 
   For example, change the line `image: docker.wso2.com/wso2ei-analytics:6.3.0` to <br> `image: wso2ei-analytics:6.3.0`. <br><br>
