...
This section defines the step-by-step instructions to build an [RockyLinux](https://hub.docker.com/_/rockylinux) Linux based Docker image for WSO2 Micro Integrator 4.6.0.
...
- Download wso2mi-4.6.0.zip from [here](https://wso2.com/products/downloads/?product=wso2integrator&package=mi)
- Host the product pack using a webserver.
- Navigate to `<MI_DOCKERFILE_HOME>` directory. 
- Execute `docker build` command as shown below.
    + `docker build -t wso2mi:4.6.0-rocky .`

> By default, the Docker image will prepackage the General Availability (GA) release version of the relevant WSO2 product.

##### 3. Running the Docker image.

- `docker run -it -p 8253:8253 -p 8290:8290 wso2mi:4.6.0-rocky`
...
In WSO2 MI 4.6.0 product distribution, `deployment.toml` configuration file can be found at `<DISTRIBUTION_HOME>/conf`.<br>
...
> In here, <TARGET_CONFIGS> refers to /home/wso2carbon/wso2mi-4.6.0/conf folder of the container.
