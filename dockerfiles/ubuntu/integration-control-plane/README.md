...
This section defines the step-by-step instructions to build an [Ubuntu](https://hub.docker.com/_/ubuntu/) Linux based Docker image for WSO2 Integration Control Plane 2.0.0.
...
- Download wso2-integration-control-plane-2.0.0.zip from [here](https://wso2.com/products/downloads/?product=wso2integrator&package=icp)
...
- Change <INTEGRATION_CONTROL_PLANE_DIST_URL> in Dockerfile to the URL of the product pack.
  Execute `docker build` command as shown below.
    + `docker build -t wso2-integration-control-plane:2.0.0 .`
...
In WSO2 Integration Control Plane 2.0.0 product distribution, `deployment.toml` configuration file can be found at `<DISTRIBUTION_HOME>/conf/server/`.<br>
...
> In here, <TARGET_CONFIGS> refers to /home/wso2carbon/wso2-integration-control-plane-2.0.0/conf/server folder of the container.
