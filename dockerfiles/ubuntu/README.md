...
- For analytics dashboard,
    + `docker run -p 9444:9444 -p 7612:7612 -p 7712:7712 -p 9161:9161 wso2ei-dashboard:6.4.0`
- for analytics worker,
    + `docker run -p 9444:9444 -p 7612:7612 -p 7712:7712 -p 9161:9161 wso2ei-worker:6.4.0`
