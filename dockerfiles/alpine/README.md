...
##### 2. Add WSO2 Enterprise Integrator distribution and required libraries.
...
- Once the WSO2 Enterprise Integrator distribution is extracted, it should be as follows:
```
